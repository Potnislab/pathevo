...
#input fastq files
for fq1 in /path/to/clean_reads/*.paired.1.fq   ## made by the script mentioned in the https://github.com/Potnislab/AtDep_2021_metagenome/blob/main/Raw%20read%20processing/quality-trimming_script
do
